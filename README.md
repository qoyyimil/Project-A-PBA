...
- Model menunjukkan kinerja yang stabil dan **tidak bias** berkat *Data Balancing*: **F1-Score Positif: 0.81** dan **F1-Score Negatif: 0.70**.  
...
### **1. Kesimpulan**
- **Distribusi sentimen:** Artikel berita tentang Uber didominasi sentimen **positif (63,74%)** dan **negatif (36,26%)**, menunjukkan persepsi publik yang cenderung mendukung inovasinya namun tetap kritis terhadap isu sosial dan etika bisnis.  
- **Pola dan tren:** Sentimen terhadap Uber bersifat **dinamis**, meningkat positif saat perusahaan berinovasi dan menurun saat muncul isu hukum, keselamatan, atau konflik internal.  
- **Cerminan persepsi publik:** Sentimen media mencerminkan bahwa Uber dipandang sebagai perusahaan **inovatif namun kontroversial**, sehingga **manajemen reputasi digital** menjadi aspek penting untuk menjaga kepercayaan publik.

### **2. Insight**
- Persepsi publik terhadap Uber menunjukkan **citra ganda**: inovatif secara teknologi namun masih dibayangi isu sosial dan etika bisnis.  
- **Media** berperan penting dalam membentuk arah sentimen publik melalui cara penyajian berita dan *framing* isu.  
- **Model DistilBERT** terbukti efektif untuk analisis sentimen berita berbahasa Inggris meski masih terbatas pada konteks ambigu.  
- **Analisis sentimen berbasis data** dapat membantu perusahaan seperti Uber mendeteksi lebih awal potensi krisis reputasi dan memperkuat strategi komunikasi publik.

### **3. Saran**
- Penelitian selanjutnya disarankan menambahkan **analisis berbasis peristiwa (event-based)** agar perubahan sentimen dapat dikaitkan dengan momen nyata seperti kebijakan, skandal, atau inovasi Uber.  
- Dari sisi metodologi, gunakan pendekatan **aspect-based sentiment analysis (ABSA)** dan model transformer yang lebih mutakhir seperti **RoBERTa** atau **DeBERTa** untuk hasil klasifikasi yang lebih akurat.  
- Bagi perusahaan, hasil penelitian ini dapat dimanfaatkan untuk memperkuat **strategi manajemen reputasi digital** dengan memantau sentimen media dan merespons isu negatif secara cepat dan transparan.
